 ...
 * @author Donald
 */
public class LineaOrdinariaTradicional extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try{
            switch(new Integer(accion).intValue()){
                case 1:    
                cargartiposTasaNAyEPL1(request, response);
                break;
                case 2:    
                cargartiposTasaEAyEPL1(request, response);
                break;
                case 3:    
                cargartiposTasaEAyNAL1(request, response);
                break;
                case 4:    
                cargarTablaL1(request, response);
                break;
            }
        }catch (Exception e){
            e.printStackTrace();
    ...
    public void cargartiposTasaNAyEPL1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
    ...
    public void cargartiposTasaEAyEPL1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
        JSONObject jsonrespuesta = new JSONObject();
        String tasa = request.getParameter("tasa");
        String periocidad = request.getParameter("periocidad");
    ...
    public void cargartiposTasaEAyNAL1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
        JSONObject jsonrespuesta = new JSONObject();
        String tasa = request.getParameter("tasa");
        String periocidad = request.getParameter("periocidad");
        double tasaUnoEA = 0.0;
    ...
    public void cargarTablaL1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
       JSONObject jsonrespuesta = new JSONObject();
        ...
        datosL1List = u.cargarDatosTablaL1(capital, cantidadMesesCiclo, tasa, periocidad);
        ...
        jsonrespuesta.put("datosL1", datosL1ListSalida);
        responderJSON(response, jsonrespuesta);
    }
