 ...
 * @author Donald
 */
public class LineaCreditoCuotaFijaTasaVariable extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try{
            switch(new Integer(accion).intValue()){
                case 1:    
                cargartiposTasaNAyEPL3(request, response);
                break;
                case 2:    
                cargartiposTasaEAyEPL3(request, response);
                break;
                case 3:    
                cargartiposTasaEAyNAL3(request, response);
                break;
                case 4:    
                cargarTablaL3(request, response);
                break;
            }
        }catch (Exception e){
            e.getStackTrace();
    ...
    public void cargartiposTasaNAyEPL3(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
    ...
    public void cargartiposTasaEAyEPL3(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
        JSONObject jsonrespuesta = new JSONObject();
        String tasa = request.getParameter("tasa");
        String periocidad = request.getParameter("periocidad");
    ...
    public void cargartiposTasaEAyNAL3(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
        JSONObject jsonrespuesta = new JSONObject();
        String tasa = request.getParameter("tasa");
        String periocidad = request.getParameter("periocidad");
        double tasaUnoEA = 0.0;
    ...
    public void cargarTablaL3(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception{
        JSONObject jsonrespuesta = new JSONObject();
        ...
        jsonrespuesta.put("datosL3", datosL1ListSalida);
        responderJSON(response, jsonrespuesta);
    }
